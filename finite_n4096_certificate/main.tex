...
This is a variant of the query problem of Aaronson and Ambainis.\footnote{
S.~Aaronson and A.~Ambainis,
\href{https://doi.org/10.1145/2746539.2746547}{\emph{Forrelation:
a problem that optimally separates quantum from classical computing}},
STOC 2015, pp.~307--316.}
...
The hypothesis is not established: supplied local-Walsh and four-cubic
intermediate bounds are false. See \path{../AUDIT.md} for counterexamples.
...
The coefficient guide \path{code/COEFFICIENTS.md} maps the 888 high-sector
rows and inherited inputs to their derivations and rounding rules.
Rounding a source value upward does not prove \eqref{eq:coefficient};
false or missing intermediate bounds leave that hypothesis unresolved.
The broader finite and adaptive claims remain open. The root
\path{README.md} gives the audit, build and replay instructions.
